...
export const createDriverProfileSchema = z.object({
    body: z.object({
        ...
        // VEHICLE TYPE - Must be one of the supported vehicle types
        vehicleType: z.enum(
        ...
        // VEHICLE NUMBER (OPTIONAL) - Must match Indian vehicle number format if provided
        vehicleNumber: z
            .string()
            .optional()  // Field is optional
            .refine((val) => {
        ...
        // PROFILE PICTURE (OPTIONAL)- Must be a valid URL if provided
